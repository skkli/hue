...
def make_logged_in_client(request=None, username="test", password="test", is_superuser=True, recreate=False, groupname=None, is_admin=False):
  """
  ...
  c = Client()
  ret = c.login(request=request, username=username, password=password)
